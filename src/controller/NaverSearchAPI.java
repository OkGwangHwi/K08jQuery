...
public class NaverSearchAPI extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) 
		...
		String clientId = "AZcc50J8HAoTXA1vkyEY"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "kjgEX5mVRk"; //애플리케이션 클라이언트 시크릿값"
        ...
        try {
        	...
        	String selectNum = req.getParameter("startNum");
        	
            text = URLEncoder.encode(searchTxt, "UTF-8");
            
            num = URLEncoder.encode(selectNum, "UTF-8");
